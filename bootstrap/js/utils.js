...
function formatCurrency(amountInCentsAsStringOrNumber,currencyLocale){var amount=parseFloat(amountInCentsAsStringOrNumber);if(isNaN(amount)){return amountInCentsAsStringOrNumber;}
...
if(isCurrencySymbolPrefix){retVal=currencySymbol+retVal;}
