<?php /* Smarty version Smarty-3.1.8, created on 2015-09-11 18:57:47
         compiled from "C:\xampp\htdocs\walkforourwater/presentation/templates\public\donate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1474155da6f3e399e05-20929212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0d7e71ded1edca704ecbcf0bb7a88a32f8622819' => 
    array (
      0 => 'C:\\xampp\\htdocs\\walkforourwater/presentation/templates\\public\\donate.tpl',
      1 => 1442012264,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1474155da6f3e399e05-20929212',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_55da6f3e44d909_22316951',
  'variables' => 
  array (
    'obj' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_55da6f3e44d909_22316951')) {function content_55da6f3e44d909_22316951($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_presentation_object')) include 'C:\\xampp\\htdocs\\walkforourwater/presentation/smarty_plugins\\function.load_presentation_object.php';
?><?php echo smarty_function_load_presentation_object(array('filename'=>"donateController",'foldername'=>"public",'assign'=>"obj"),$_smarty_tpl);?>
								...
								<div class="form-group">
									...
									<div id="other_amount_div">	
										...
										<div class="input-group">
										  ...
										  <input type="text" class="form-control input-small" aria-label="Amount (to the nearest dollar)" id=amount name="amount" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['amount'];?>
"/>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="first_name" type="text"  value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['first_name'];?>
" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="last_name" type="text"  value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['last_name'];?>
" />
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
									  <div class="form-group">
											...
											<input class="form-control"  id=email name="email" type="email" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['email'];?>
" />
									</div>
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
								  ...
								  <input class="form-control" name="phone" type="tel" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['phone'];?>
"/>
								</div>
							</div>
						</div>	
						...
						<div class="row">	
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="address" type="text"  value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['address'];?>
" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="city" type="text" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['city'];?>
" />
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="zip" type="text" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value->mP['zip'];?>
" />
								</div>
							</div>
						</div>
